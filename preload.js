...
contextBridge.exposeInMainWorld('pamp', {
  ...
  nodeInstall: (pkg) => ipcRenderer.invoke('node:install', pkg),
  nodeUninstall: (pkg) => ipcRenderer.invoke('node:uninstall', pkg),
  onNodeLog: (fn) => ipcRenderer.on('node:log', (_e, payload) => fn(payload)),
